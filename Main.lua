...
-- Função para carregar a lógica do Farm
local Init = function()
    loadstring(game:HttpGet('https://raw.githubusercontent.com/Nikev2/SpaceSailors/refs/heads/main/v2.lua'))()
end

-- Gestão de ficheiro JSON
if not isfile(FileName) then
    writefile(FileName, http:JSONEncode({AutoFarm = false}))
end
...
-- Adicionado Section para mostrar status
Divider:Section{ Name = "Status: Active | Versão: 1.0.0" }
...
QuitDivider:Button{
   Name = "Close Script",
   Callback = function()
       ScreenGui:Destroy() -- Remove o botão 🚀
       UI:Quit{
           Message = "Destroyed",
           Length = 1
       }
